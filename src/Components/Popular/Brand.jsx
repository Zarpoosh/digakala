...
const Brand = () => {
  ...
  return (
    <>
      ...
      <div
        id="content"
        className="scroll-smooth carousel scrollbar-hide lg:w-4/5 border border-gray-200 mx-3 lg:mx-auto flex flex-row rounded-lg overflow-x-auto"
      >
        {/* <ScrollBtn/> */}
        ...
        {imagecards.map((card) => (
          <div          
            key={card.url}
            className="hover:shadow-2xl flex flex-col border p-5 border-gray-200 justify-center items-center"
          >
            <a
              className="h-14 w-14 my-4 flex flex-col items-center m-2"
              href="#"
            >
